...
public class ParticlesDisplay extends JComponent implements MouseListener,
  MouseMotionListener, ActionListener, ChangeListener
{
  ...
  public ParticlesDisplay(String title, int numRows, int numCols, String[] buttonNames)
  {
